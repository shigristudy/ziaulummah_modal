      ...
      <div class="flex h-full flex-col">
        ...
        <div class="border-t border-gray-200 py-6 px-4 sm:px-10" v-if="projects">
          ...
          <div class="mb-4 flex justify-between">
            <button 
              @click="viewBasket()"
              type="button" class="px-6 pt-2.5 pb-2 bg-gray-600 text-white font-medium text-xs leading-normal uppercase rounded shadow-md hover:bg-green dark:hover:bg-black hover:shadow-lg focus:bg-green dark:focus:bg-black focus:shadow-lg focus:outline-none focus:ring-0 dark:active:bg-black active:bg-green active:shadow-lg transition duration-300 ease-in-out flex align-center items-center">
